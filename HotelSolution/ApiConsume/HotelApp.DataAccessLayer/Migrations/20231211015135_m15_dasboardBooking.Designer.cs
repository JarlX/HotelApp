...
namespace HotelApp.DataAccessLayer.Migrations
{
    ...
    [Migration("20231211015135_m15_dasboardBooking")]
    partial class m15_dasboardBooking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelApp.EntityLayer.Concrete.About", b =>
                {
            ...
            modelBuilder.Entity("HotelApp.EntityLayer.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelApp.EntityLayer.Concrete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelApp.EntityLayer.Concrete.Booking", b =>
                {
            ...
            modelBuilder.Entity("HotelApp.EntityLayer.Concrete.Contact", b =>
                {
            ...
            modelBuilder.Entity("HotelApp.EntityLayer.Concrete.Guest", b =>
                {
            ...
            modelBuilder.Entity("HotelApp.EntityLayer.Concrete.MessageCategory", b =>
                {
                    b.Property<int>("MessageCategoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("MessageCateegoryName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HotelApp.EntityLayer.Concrete.Room", b =>
                {
            ...
            modelBuilder.Entity("HotelApp.EntityLayer.Concrete.SendMessage", b =>
                {
            ...
            modelBuilder.Entity("HotelApp.EntityLayer.Concrete.Service", b =>
                {
            ...
            modelBuilder.Entity("HotelApp.EntityLayer.Concrete.Staff", b =>
                {
            ...
            modelBuilder.Entity("HotelApp.EntityLayer.Concrete.Subscribe", b =>
                {
            ...
            modelBuilder.Entity("HotelApp.EntityLayer.Concrete.Testimonial", b =>
                {
            ...
            modelBuilder.Entity("HotelApp.EntityLayer.Concrete.WorkLocation", b =>
                {
                    b.Property<int>("WorkLocationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelApp.EntityLayer.Concrete.AppUser", b =>
                {
                    b.HasOne("HotelApp.EntityLayer.Concrete.WorkLocation", "WorkLocation")
                        .WithMany("AppUsers")
            ...
            modelBuilder.Entity("HotelApp.EntityLayer.Concrete.Contact", b =>
                {
                    b.HasOne("HotelApp.EntityLayer.Concrete.MessageCategory", "MessageCategory")
                        .WithMany("Contacts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("HotelApp.EntityLayer.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("HotelApp.EntityLayer.Concrete.AppUser", null)
                        .WithMany()
